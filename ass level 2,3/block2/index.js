...
console.log(minToSec(2) )
  ...
  */
  ...
  console.log(calculateBMI(100,5))
  /* 3. appropiateDrinks
  ...
  */
  ...
  console.log(appropiateDrinks(19))
  ...
  */
  ...
  // Function Test
  console.log(addtwo(2,"qju"))
  
    

  let age=20
  age<25?console.log("yes"):console.log("no")
  let userAge = NaN;
(userAge)==NaN?alert(`The value is Nan`):alert(`Sorry the value is not Nan`);